...
return [
    ...
    'version_urls' => false,
    'image_optimizers' => [
        Jpegoptim::class => ['-m85', '--force', '--strip-all', '--all-progressive'],
        Pngquant::class => ['--force'],
        Optipng::class => ['-i0', '-o2', '-quiet'],
        Svgo::class => ['--disable=cleanupIDs'],
        Gifsicle::class => ['-b', '-O3'],
        Cwebp::class => ['-m 6', '-pass 10', '-mt', '-q 90'],
        Avifenc::class => ['-a cq-level=23', '-j all', '--min 0', '--max 63'],
    ],
    'image_generators' => [Image::class, Webp::class, Avif::class, Pdf::class, Svg::class, Video::class],
